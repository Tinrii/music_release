...
const Navbar = ({ buttonState, onToggle }: NavbarProps) => {
    return (
        <nav className='flex justify-between items-center h-16 sm:flex-wrap absolute top-0 left-0 right-0 px-10 z-90 bg-transparent'>
            ...
            <div className="logo md:absolute left-1/2 -translate-x-1/2">
